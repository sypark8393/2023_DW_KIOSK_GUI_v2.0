	...
	public void start(Scanner sc) {
		...
		while (true) {
			...
			case '2': // 주문번호로 조회
				...
				salesTotalData.searchData(SalesTotal.INDEX_ORDER_NO, orderNo); // 주문번호로 조회 및 출력
				break;
			...
			case '3': // 매장/포장 여부로 조회
				...
				salesTotalData.searchData(SalesTotal.INDEX_ORDER_TYPE, (type == '1') ? "매장" : "포장"); // 매장/포장 기준으로 조회 및 출력
				break;
			...
			case '4': // 결제방법으로 조회
				...
				salesTotalData.searchData(SalesTotal.INDEX_PAY_METHOD, payMethod); // 신용카드/간편결제 기준으로 조회 및 출력
				break;
