	...
	public void startSalesDetailProcess(Scanner sc) {
		...
		while (true) {
			...
			case '2': // 주문번호로 조회
				...
				salesDetailData.searchData(SalesDetail.INDEX_ORDER_NO, orderNo);
				break;
			...
			case '3': // 유형(메뉴/포인트/쿠폰)으로 조회
				...
				salesDetailData.searchData(SalesDetail.INDEX_TYPE, strType);
				break;
			...
			case '4': // ID로 조회
				...
				salesDetailData.searchData(SalesDetail.INDEX_ID, id);
				break;
